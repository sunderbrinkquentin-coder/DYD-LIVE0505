...
/** Bulletpoints einer Berufsstation aus den möglichen Quellfeldern lesen (für den Hero-Substanz-Beweis). */
...
/** Sprachnamen tolerant aus verschiedenen Feldern lesen (KI-Output nutzt teils andere Feldnamen). */
...
export function WizardCVOverview({ isOpen, cvData, cvId, onClose, onContinue, mode = 'create' }: WizardCVOverviewProps) {
  ...
  const firstName = p.firstName || (nameStr ? nameStr.split(' ')[0] : '');
