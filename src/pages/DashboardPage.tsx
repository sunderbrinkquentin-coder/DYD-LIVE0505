  ...
  (p) => !p.certificate_url && ((p as any).final_exam_score ?? 0) >= 80
            ...
            return (
              <div className="space-y-4">
                ...
                {/* ── 4. Zertifikate ───────────────────────────────────────── */}
                {certReady.map((path) => (
  <div key={path.id} className="flex items-center gap-3 px-4 py-3 rounded-2xl"
    ...
    <div className="flex-1 min-w-0">
      ...
      <p className="text-[10px] text-white/35 mt-0.5">Prüfung bestanden — Zertifikat abholen</p>
    </div>
    <button
